...
<div class="w-100">
    <div class="container">
        <h4>Contrato N° <?php echo $contrato[0]['idReferencial'] ?></h4>
        <input type="hidden" id="idContrato" class="form-control" value="<?php echo $contrato[0]['idReferencial'] ?>"
            name="idContrato" />
        <input type="hidden" id="idProforma" class="form-control" value="<?php echo $proforma[0]["idreferencial"] ?>"
            name="idProforma" />
        <div class="row mb-3" style="border: 1px solid black;">
            ...
            <div class="mb-3 col-12">
                ...
                <input readonly type="text" id="idProforma" class="form-control"
                    value="<?php echo $contrato[0]['idProforma'] ?>" name="idProforma" />
            </div>
            <div class="mb-3 col-4">
                <label for="nombre" class="form-label">Nombres</label>
                <input readonly type="text" class="form-control" name="nombres"
                    value="<?php echo $contrato[0]['nombres'] ?>" />
            </div>
            <div class="mb-3 col-4">
                <label for="apellidoP" class="form-label">Apellido Paterno</label>
                <input readonly type="text" class="form-control" name="apellidoP"
                    value="<?php echo $contrato[0]['apellidoP'] ?>" />
            </div>
            <div class="mb-3 col-4">
                <label for="apellidoM" class="form-label">Apellido Materno</label>
                <input readonly type="text" class="form-control" name="apellidoM"
                    value="<?php echo $contrato[0]['apellidoM'] ?>" />
            </div>
            <div class="mb-3 col-4">
                <label for="celular" class="form-label">Celular</label>
                <input readonly type="number" class="form-control" name="celular"
                    value="<?php echo $contrato[0]['celular'] ?>" />
            </div>
            <div class="mb-3 col-4">
                <label for="dni" class="form-label">DNI</label>
                <input readonly type="number" class="form-control" name="dni"
                    value="<?php echo $contrato[0]['dni'] ?>" />
            </div>
            <div class="mb-3 col-4">
                <label for="correo" class="form-label">Correo</label>
                <input readonly type="email" class="form-control" name="correo"
                    value="<?php echo $contrato[0]['correo'] ?>" />
            </div>
        </div>
        <div class="row mb-3" style="border: 1px solid black;">
            ...
            <div class="mb-3 col-4">
                ...
                <input readonly type="text" class="form-control" name="departamento"
                    value="<?php echo $contrato[0]['departamento'] ?>" />
            </div>
            <div class="mb-3 col-4">
                <label for="provincia" class="form-label">Provincia</label>
                <input readonly type="text" class="form-control" name="provincia"
                    value="<?php echo $contrato[0]['provincia'] ?>" />
            </div>
            <div class="mb-3 col-4">
                <label for="distrito" class="form-label">Distrito</label>
                <input readonly type="text" class="form-control" name="distrito"
                    value="<?php echo $contrato[0]['distrito'] ?>" />
            </div>
            <div class="mb-3 col-6">
                <label for="direccion" class="form-label">Dirección</label>
                <input readonly type="text" class="form-control" name="direccion"
                    value="<?php echo  $contrato[0]['direccion']  ?>" />
            </div>
            <div class="mb-3 col-6">
                <label for="referencia" class="form-label">Referencia</label>
                <input readonly type="text" class="form-control" name="referencia"
                    value="<?php echo  $contrato[0]['referencia']  ?>" />
            </div>
        </div>
        <h4>Proforma N° <?php echo $proforma[0]["idreferencial"] ?></h4>
        <table class="table">
            <thead>
                <tr>
                    <th scope="col">#</th>
        ...
        <h4>Importe Total = S/. <?php echo $totalImporte ?></h4>
